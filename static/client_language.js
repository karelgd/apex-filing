(function () {
  ...
  const dictionaries = {
    es: {
      ...
      message_center_help: "Envíe y reciba mensajes seguros sin salir de Apex.",
      message_center_card_help: "Envíe un mensaje seguro a su agencia y revise el historial completo de la conversación.",
      open_messages: "Abrir mensajes",
      secure_files: "Archivos seguros",
      document_center: "Centro de documentos",
      document_center_help: "Revise los documentos que subió y los documentos que su agencia compartió con usted.",
      document_center_card_help: "Vea y descargue sus archivos y los documentos compartidos por su agencia.",
      open_documents: "Abrir documentos",
      uploaded_on: "Subido",
      uploaded_by_you: "Subido por usted",
      shared_by_agency: "Compartido por la agencia",
      view: "Ver",
      download: "Descargar",
      no_documents_available: "Aún no hay documentos disponibles.",
      document_center_empty_help: "Los documentos que suba mediante un caso y los que comparta su agencia aparecerán aquí.",
      secure_agency_conversation: "Conversación segura con su agencia",
      start_conversation: "Inicie la conversación",
      start_conversation_help: "Escriba un mensaje abajo. El historial de la conversación permanecerá disponible aquí.",
      message_placeholder: "Escriba un mensaje...",
      send: "Enviar",
      enter_to_send: "Presione Enter para enviar. Use Shift + Enter para una línea nueva.",
      ...
      case_status_changed_to: "El estado de su caso cambió a",
      on_date: "el",
      tracking_number_intro: "y el número de rastreo asociado con su paquete es",
      ...
      "Choose a document to upload.": "Elija un documento para subir.",
      "For security, only PDF, image, and DOCX files are accepted.": "Por seguridad, solo se aceptan archivos PDF, imagen y DOCX.",
    ...
    ht: {
      ...
      message_center: "Sant mesaj",
      message_center_help: "Voye epi resevwa mesaj an sekirite san ou pa kite Apex.",
      message_center_card_help: "Voye yon mesaj an sekirite bay ajans ou epi gade tout istwa konvèsasyon an.",
      open_messages: "Louvri mesaj yo",
      secure_files: "Fichye an sekirite",
      document_center: "Sant dokiman",
      document_center_help: "Gade dokiman ou te telechaje ak dokiman ajans ou pataje avèk ou.",
      document_center_card_help: "Gade epi telechaje fichye ou yo ak dokiman ajans ou pataje avèk ou.",
      open_documents: "Louvri dokiman yo",
      uploaded_on: "Telechaje",
      uploaded_by_you: "Ou te telechaje li",
      shared_by_agency: "Ajans lan pataje li",
      view: "Gade",
      download: "Telechaje",
      no_documents_available: "Pa gen dokiman disponib ankò.",
      document_center_empty_help: "Dokiman ou telechaje atravè yon dosye ak dokiman ajans ou pataje ap parèt isit la.",
      secure_agency_conversation: "Konvèsasyon an sekirite ak ajans ou",
      start_conversation: "Kòmanse konvèsasyon an",
      start_conversation_help: "Ekri yon mesaj anba a. Istwa konvèsasyon an ap rete disponib isit la.",
      message_placeholder: "Ekri yon mesaj...",
      send: "Voye",
      enter_to_send: "Peze Enter pou voye. Sèvi ak Shift + Enter pou yon nouvo liy.",
      ...
      case_status_changed_to: "Estati dosye ou chanje pou",
      on_date: "nan dat",
      tracking_number_intro: "epi nimewo swivi ki asosye ak pakè ou a se",
      ...
      "Document uploaded.": "Dokiman telechaje.",
      "Documents uploaded.": "Dokiman yo telechaje.",
      "Progress saved.": "Pwogre a anrejistre.",
      "Choose a document to upload.": "Chwazi yon dokiman pou telechaje.",
      "For security, only PDF, image, and DOCX files are accepted.": "Pou sekirite, se selman PDF, imaj ak DOCX yo aksepte.",
