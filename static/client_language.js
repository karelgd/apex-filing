(function () {
  ...
  const dictionaries = {
    es: {
      ...
      immigration_court_information: "Informacion de la corte de inmigracion",
      court_information_help: "Revise la informacion mas reciente de la corte verificada por su agencia.",
      immigration_judge: "Juez de inmigracion",
      next_hearing: "Proxima audiencia",
      hearing_type: "Tipo de audiencia",
      hearing_mode: "Modalidad de audiencia",
      court: "Corte",
      last_verified: "Ultima verificacion",
      no_court_information: "Aun no se ha agregado informacion de la corte de inmigracion a este caso.",
      court_notice_disclaimer: "Las notificaciones emitidas a usted o a su representante son la fuente oficial de informacion.",
    ...
    ht: {
      ...
      immigration_court_information: "Enfomasyon tribinal imigrasyon",
      court_information_help: "Gade denye enfomasyon tribinal ajans ou verifye.",
      immigration_judge: "Jij imigrasyon",
      next_hearing: "Pwochen odyans",
      hearing_type: "Kalite odyans",
      hearing_mode: "Fason odyans lan ap fet",
      court: "Tribinal",
      last_verified: "Denye verifikasyon",
      no_court_information: "Poko gen enfomasyon tribinal imigrasyon pou dosye sa a.",
      court_notice_disclaimer: "Avi tribinal voye ba ou oswa reprezantan ou se sous ofisyel enfomasyon an.",
