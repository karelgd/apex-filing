...
class MotionDraft(db.Model):
    ...
    is_change_of_venue = db.Column(db.Boolean, default=False, nullable=False)
    former_address_line = db.Column(db.String(240))
    former_city_state_zip_country = db.Column(db.String(240))
    current_address_line = db.Column(db.String(240))
    current_city_state_zip_country = db.Column(db.String(240))
