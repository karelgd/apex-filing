...
class CrmCase(db.Model):
    ...
    immigration_judge = db.Column(db.String(180))
    hearing_at = db.Column(db.DateTime)
    hearing_type = db.Column(db.String(80))
    hearing_mode = db.Column(db.String(80))
    court_name = db.Column(db.String(180))
    court_address = db.Column(db.Text)
    court_phone = db.Column(db.String(40))
    court_email = db.Column(db.String(160))
    court_verified_at = db.Column(db.DateTime)
    notes = db.Column(db.Text)
    created_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
