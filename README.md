...
- `SURVEY_BASE_URL`: Optional. Public site origin used for secure client survey links. When omitted, links use the same live host where the case completion was submitted.
